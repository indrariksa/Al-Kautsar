...
<!--     <script src="<?php echo base_url("assets/js/jquery.min.js"); ?>"></script> --> <!-- Load library jquery -->
    <script src="<?php echo base_url("assets/js/cari_bayar.js"); ?>"></script> <!-- Load file process.js -->
<script>  
  ...
  // $("#btn-search").click(function(){ 
      ...
      $("#btn-search").click(function(){ 
          // $("#id_result").hide();
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>Pelunasan/check_id_avalibility",  
                     method:"POST",  
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Pelunasan Hewan Kurban</h1>
          <p>Input Pelunasan</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Form Pelunasan</a></li>
        </ul>
      </div>
      <?php
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Input Pelunasan</h3>
            <form action="<?php echo base_url('Pelunasan'); ?>" enctype="multipart/form-data" method="post">
            <div class="tile-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">Sudah Dibayar</label>
                  <input class="form-control" name="jml_bayar" id="jml_bayar" readonly>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="control-label">Sisa</label>
                  <input class="form-control" name="sisa" id="sisa" readonly>
                </div>
              </div>
              <div class="col-lg-12">
              <div class="form-group">
                  ...
                  <input class="dibayar form-control input-sm" type="text" id="dibayar" name="dibayar" placeholder="Masukan Jumlah Pembayaran" required autocomplete="off" oninvalid="this.setCustomValidity('Kolom penerima harus diisi')" oninput="setCustomValidity('')">
                  <input type="hidden" id="dibayar2" name="dibayar2" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" required>
                  </div>
              </div>
