...
<!--                             <th>No Reg Hewan</th> -->
                    ...
                    <tbody>
                        ...
                        <?php if ($d->status_kirim == 'sudah'): ?>
                        <tr style="background-color: #bbcaff">
                          <td><?php echo $no++ ?></td>
                        <?php elseif ($d->keterangan == 'p2hq'): ?>
                        <tr style="background-color: #85ff95">
                          <td><?php echo $no++ ?></td>
                        <?php elseif ($d->keterangan == 'ambil'): ?>
                        <tr style="background-color: #fff6c9">
                          <td><?php echo $no++ ?></td>
                          <?php else: ?>
                        <tr>
                            <td><?php echo $no++ ?></td>
                          <?php endif; ?>
                            ...
                            <td><b><?php
                                if($d->status_kirim == 'sudah' AND $d->keterangan == 'p2hq'){
                                    echo "<span class='badge badge-success'>Sudah Dikirim</span><br><span class='badge badge-primary'>P2HQ</span>";
                                }elseif($d->status_kirim == 'sudah'){
                                    echo "<span class='badge badge-success'>Sudah Dikirim</span>";
                                }elseif($d->status_kirim == 'belum' AND $d->keterangan == 'ambil'){
                                    echo "<span class='badge badge-info'>Ambil Sendiri</span>";
                                }elseif($d->status_kirim == 'belum' AND $d->keterangan == 'p2hq'){
                                    echo "<span class='badge badge-warning'>Belum Dikirim</span><br><span class='badge badge-primary'>P2HQ</span>";
                                }else{
