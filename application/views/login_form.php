...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/login_v2/images/bg.jpg');background-repeat: no-repeat;
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url('Login/login_akses');?>" method="post">
					...
					<div class="txt1 text-center p-t-54 p-b-20">
						<span>
							<img class="logo-poltekpos" src="<?php echo base_url('assets/images/logo.png'); ?>" width="200px">
						</span>
					</div>
